...
export default class IntroScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("bungalow", "assets/images/bungalow.png");
        this.load.image("hotel", "assets/images/hotel.png");
        this.load.image("manIntroPic", "assets/sprites/man/man-intro.png");
        this.load.image("manFinalPic", "assets/sprites/man/man-final.png");
        this.load.image("manIntroPhrase", "assets/sprites/man/man-intro-phrase.png");
        this.load.image("manFinalPhrase", "assets/sprites/man/man-final-phrase.png");
        this.load.image("womanDefault", "assets/sprites/woman/woman-intro.png");
        this.load.image("womanChoice1", "assets/sprites/woman/woman-choice-1.png");
        this.load.image("womanCloth1", "assets/sprites/woman/cloth-1.png");
        this.load.image("womanCloth2", "assets/sprites/woman/cloth-2.png");
        this.load.image("womanCloth1Bag1", "assets/sprites/woman/cloth-1-bag-1.png");
        this.load.image("womanCloth1Bag2", "assets/sprites/woman/cloth-1-bag-2.png");
        this.load.image("womanCloth2Bag1", "assets/sprites/woman/cloth-2-bag-1.png");
        this.load.image("womanCloth2Bag2", "assets/sprites/woman/cloth-2-bag-2.png");
        this.load.image("womanCloth1Bag1Acc1", "assets/sprites/woman/cloth-1-bag-1-acc-1.png");
        this.load.image("womanCloth1Bag1Acc2", "assets/sprites/woman/cloth-1-bag-1-acc-2.png");
        this.load.image("womanCloth1Bag2Acc1", "assets/sprites/woman/cloth-1-bag-2-acc-1.png");
        this.load.image("womanCloth1Bag2Acc2", "assets/sprites/woman/cloth-1-bag-2-acc-2.png");
        this.load.image("womanCloth2Bag1Acc1", "assets/sprites/woman/cloth-2-bag-1-acc-1.png");
        this.load.image("womanCloth2Bag1Acc2", "assets/sprites/woman/cloth-2-bag-1-acc-2.png");
        this.load.image("womanCloth2Bag2Acc1", "assets/sprites/woman/cloth-2-bag-2-acc-1.png");
        this.load.image("womanCloth2Bag2Acc2", "assets/sprites/woman/cloth-2-bag-2-acc-2.png");
        this.load.image("womanIntroPhrase", "assets/sprites/woman/woman-intro-phrase.png");
        this.load.image("cloth1", "assets/sprites/clothes-icons/cloth-1.png");
        this.load.image("cloth2", "assets/sprites/clothes-icons/cloth-2.png");
        this.load.image("bag1", "assets/sprites/clothes-icons/bag-1.png");
        this.load.image("bag2", "assets/sprites/clothes-icons/bag-2.png");
        this.load.image("acc1", "assets/sprites/clothes-icons/acc-1.png");
        this.load.image("acc2", "assets/sprites/clothes-icons/acc-2.png");
        this.load.image("bungalowIcon", "assets/sprites/other/bungalow-icon.png");
        this.load.image("hotelIcon", "assets/sprites/other/hotel-icon.png");
        this.load.image("hand", "assets/sprites/other/hand.png");
        this.load.image("playNowButton", "assets/sprites/other/play-now-button.png");
        this.load.image("chooseDressPhrase", "assets/sprites/other/choose-dress-phrase.png");
        this.load.image("chooseBagPhrase", "assets/sprites/other/choose-bag-phrase.png");
        this.load.image("chooseAccPhrase", "assets/sprites/other/choose-acc-phrase.png");
        this.load.image("choosePlacePhrase", "assets/sprites/other/choose-place-phrase.png");
        this.load.image("progressBar0", "assets/sprites/other/progress-bar-0.png");
        this.load.image("progressBar1", "assets/sprites/other/progress-bar-1.png");
        this.load.image("progressBar2", "assets/sprites/other/progress-bar-2.png");
        this.load.image("progressBar3", "assets/sprites/other/progress-bar-3.png");
    }
